...
namespace DAL.Context {
    internal class EksamensInit : CreateDatabaseIfNotExists<EksamensContext>{
        protected override void Seed(EksamensContext context) {
            ...
            Employee employee = new Employee("sna", 11111111, "Bob", dep1);
            Employee employee2 = new Employee("Bnb", 22222222, "Danny", dep1);
            Employee employee3 = new Employee("msa",33333333, "Misha", dep1);
